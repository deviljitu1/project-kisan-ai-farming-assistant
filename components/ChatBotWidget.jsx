...
const mockBotReply = (msg, lang) => {
  ...
  if (msg.toLowerCase().includes('pump')) return lang === 'hi' ? 'पंप चालू कर दिया गया है।' : lang === 'kn' ? 'ಪಂಪ್ ಆನ್ ಮಾಡಲಾಗಿದೆ.' : 'Pump has been turned on.';
...
export default function ChatBotWidget() {
  ...
  const [messages, setMessages] = useState([
    { from: 'bot', text: 'Hi! 👋 Ask me anything about farming, soil, irrigation, or government schemes.', lang: 'en' },
  ]);
